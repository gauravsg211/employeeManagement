...
router.patch('/employee/:id', upload.single('ProfilePicUrl'), (req,res,next)=>{
 ...
 var EmployeeId=req.params.id;
		...
		request.query("exec updateEmployeeDetailsById @EmployeeId="+EmployeeId+",@NickName='"+req.body.NickName+"',@DateOfBirth='"+req.body.DateOfBirth+"',@pastExperience="+req.body.PastExperience+";", function (err, recordset){
...
router.patch('admin/:id', upload.single('ProfilePicUrl'), (req,res,next)=>{
